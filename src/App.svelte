<script lang="ts">
    ...
    const flashCards = [
        ...
        // Ι
        { id: 77, question: "οὐδέ", answer: "en niet, maar niet" },
        { id: 78, question: "πατήρ, ὁ", answer: "vader, πατρος" },
        { id: 79, question: "οὐδέν", answer: "niets, helemaal niet" },
        { id: 80, question: "ὅτι", answer: "al" },
        { id: 81, question: "οὐκέτι", answer: "niet meer" },
        {
            id: 82,
            question: "πᾶς",
            answer: "geheel, ieder, alle, alles, allen",
        },
        { id: 83, question: "σῶμα, το", answer: "lichaam, σώματος" },
        { id: 84, question: "παῖς, ὁ/ἡ", answer: "kind, slaaf, παιδος" },
        { id: 85, question: "οἷος τε εἰμί", answer: "in staat zijn" },
        { id: 86, question: "γυνή, ἡ", answer: "vrouw, γυναίκος" },

        // Κ
        { id: 87, question: "ὑμετέρος", answer: "uw, (van) jullie" },
        { id: 88, question: "ὑμετέρος", answer: "onze, (van) ons" },
        { id: 89, question: "μητήρ, ἡ", answer: "moeder, μητρος" },
        { id: 90, question: "ὀλίγος", answer: "weinig" },
        { id: 91, question: "μετά", answer: "zeer" },
        { id: 92, question: "εὖ", answer: "goed" },
        { id: 93, question: "πόλις, ἡ", answer: "stad, πόλεως" },
